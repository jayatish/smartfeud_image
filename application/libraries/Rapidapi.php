...
class Rapidapi {
     ...
     */
	function Rapidapi($params=array()) {
		$this->CI =& get_instance();
		$this->CI->load->config('eway_config');
		$this->username = $this->CI->config->item('eway_userapi');
		$this->password = $this->CI->config->item('eway_userpassword');
